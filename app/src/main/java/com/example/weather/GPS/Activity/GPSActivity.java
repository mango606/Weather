...
import com.example.weather.Area.Activity.AreaActivity;
import com.example.weather.GPS.Day.GPSDay;
import com.example.weather.GPS.Define.DefineAPI.DefineAPI;
import com.example.weather.GPS.GPSTracker.GPSTracker;
...
public class GPSActivity extends AppCompatActivity {
    ...
    GPS cGPS;           //!< Activty 하위클래스
    GPSDay cGPSDay;     //!< 현재위치 날짜 클래스

    private GPSTracker gpsTracker;      //!< GPS 추적기
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cGPS = new GPS(this);        //!< GPS하위클래스 객체생성
        cGPS.setGPS();                                //!< GPS하위클래스 메서드

        cGPSDay = new GPSDay(this);  //!< GPS날짜 객체생성
        cGPSDay.getDay();                             //!< GPS날짜 메서드

        Button button = (Button)findViewById(R.id.mainbt1);     //!< 지역별날씨 클릭 리스너
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(GPSActivity.this, AreaActivity.class); //!< 인텐트 GPS Activty -> 지역Activity
        ...
        DefineAPI.ins().latitude = Double.toString(gpsTracker.getLatitude());
        DefineAPI.ins().longitude = Double.toString(gpsTracker.getLongitude());
    ...
    public void onRequestPermissionsResult(int permsRequestCode,
        ...
        if ( permsRequestCode == PERMISSIONS_REQUEST_CODE && grandResults.length == REQUIRED_PERMISSIONS.length) {
            ...
            if ( check_result ) {
                ...
                // 거부한 퍼미션이 있다면 앱을 사용할 수 없는 이유를 설명해주고 앱을 종료. 2가지 경우가 있음.
